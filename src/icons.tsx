...
export const MutedIcon: React.FC<{ size?: number; color?: string }> = ({ size = 18, color = GD_PURPLE }) => (
...
export const ChairIcon: React.FC<{ size?: number; color?: string }> = ({ size = 18, color }) => (
  <I size={size} color={color}><path d="M19 9V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 6v3" /><path d="M3 16h18v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-2z" /><path d="M5 16V9h14v7" /></I>
);
export const CodeIcon: React.FC<{ size?: number; color?: string }> = ({ size = 18, color }) => (
  <I size={size} color={color}><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></I>
);
